...
class MATCH_0(nn.Module):
    def __init__(self, n_items, n_cat, n_base, out_len):
        ...
        self.long2 = conv_block(16, 16, dprob=0.4, kernel_size=5, padding=3)
        
        self.long3 = conv_block(16, 16, dprob=0.4, kernel_size=5, padding=3)
        
        self.long4 = conv_block(16, 16, dprob=0.4, kernel_size=3)
...
class conv_block(nn.Module):
    def __init__(self, in_channels, out_channels, dprob, **kwargs):
        super().__init__()
